...
- **Evidence:** `src/VisionWeave.Application/Editing/`, `src/VisionWeave.Persistence/Workflows/WorkflowSession.cs`, `src/VisionWeave.Persistence/Workflows/WorkflowSessionResult.cs`, `src/VisionWeave.Domain/Workflows/WorkflowDocument.cs` (`ChangeCount`), `src/VisionWeave.Application/Validation/WorkflowValidator.cs` (`ValidateConnection`), `tests/VisionWeave.Application.Tests/Editing/`, `tests/VisionWeave.Persistence.Tests/Workflows/WorkflowSessionTests.cs`, `docs/design/visionweave-detailed-design.md` (sections 4.3, 6.1, 7, and 10).
- **Owner:** VisionWeave maintainers.
