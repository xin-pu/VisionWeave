...
public static class OpenCvExecutors
{
    ...
    public static IReadOnlyDictionary<string, INodeExecutor> CreateDefaults(ILeaseLedger ledger)
    {
        ...
        return new Dictionary<string, INodeExecutor>(StringComparer.Ordinal)
        {
            ...
            [OpenCvNodeIds.SplitChannelsExecutorTypeId] = new SplitChannelsExecutor(ledger),
            [OpenCvNodeIds.MergeChannelsExecutorTypeId] = new MergeChannelsExecutor(ledger),
            [OpenCvNodeIds.ExtractChannelExecutorTypeId] = new ExtractChannelExecutor(ledger),
            [OpenCvNodeIds.CopyMakeBorderExecutorTypeId] = new CopyMakeBorderExecutor(ledger),
            [OpenCvNodeIds.TransposeExecutorTypeId] = new TransposeExecutor(ledger),
